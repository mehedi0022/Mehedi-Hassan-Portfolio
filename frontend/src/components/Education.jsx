...
const Education = () => {
  return (
    <div
      id="education"
      className="container mx-auto px-5 py-10 overflow-x-hidden"
    >
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-10 justify-center">
        <div>
          ...
          <motion.div
            ...
            className="group mt-7 pl-[3rem] relative before:content-[''] before:w-[1px] before:top-0 before:left-[.45rem] before:absolute before:h-full before:bg-bttonColour cursor-pointer z-1"
          >
            ...
            <h1 className="text-[.813rem] mb-2">Department of CSE</h1>
        ...
        <div>
          ...
          >
            ...
            <h1 className="text-[.813rem] mb-2">
              Web Developer and Virtual Assistant
            </h1>
          ...
          >
            ...
            <h1 className="text-[.813rem] mb-2">I have Complied 31 Project</h1>
